   ...
   <div class="container-fluid page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Khoá Học</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Trang Chủ</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Khoá Học</p>
                </div>
            </div>
        </div>
    </div>
            ...
            foreach($hienthikh as $kq){
                    ...
                    echo '  
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="index.php?act=chitietkhoahoc&courseID='.$kq['courseID'].'" alt="">
                                <div class="rounded overflow-hidden mb-2">
                                    <img class="img-fluid" src="../dacn-web/admin/assets/img/'.$kq['img'].'" alt="" style="width:350px;height:240px">
